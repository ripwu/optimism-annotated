...
var (
	...
	// in the OVM_GasPriceOracle predeploy
	...
	// L2GasPriceOracleAddress is the address of the OVM_GasPriceOracle predeploy
	// 修改来源：go/gas-oracle/oracle/updater_interface.go: wrapUpdateL2GasPriceFn()
